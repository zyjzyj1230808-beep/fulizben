...
export const metadata: Metadata = {
  ...
  title: {
    default: "Buoyancy Capital - Professional Training Platform | 浮力资本·金融交易职业交易员培训",
    template: "%s | Buoyancy Capital"
  },
  description: "Buoyancy Capital (浮力资本) - 专注于金融交易的职业交易员培训平台。提供系统化金融交易培训、实战训练和资金支持。通过专业考核即可获得资金管理权限，分润比例高达90%。培养真正适合金融市场的专业交易员。",
  keywords: [
    "Buoyancy Capital",
    "浮力资本",
    "金融交易",
  ...
  alternates: {
    ...
    languages: {
      'zh-CN': 'https://fuliziben.com/zh',
      'en-US': 'https://fuliziben.com/en',
    },
  },
  openGraph: {
    type: "website",
    ...
    title: "Buoyancy Capital - Professional  Training Platform | 浮力资本·职业交易员培训",
    description: "专注于金融交易的职业交易员培训平台。提供系统化金融交易培训、实战训练和资金支持。通过专业考核即可获得资金管理权限，分润比例高达90%。",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    site: "@fuliziben",
    creator: "@fuliziben",
    title: "Buoyancy Capital - Professional  Training Platform",
    description: "专注于金融交易的职业交易员培训平台。提供系统化金融交易培训、实战训练和资金支持。",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
