...
export const candlestickPatternsContent = {
  zh: {
    ...
    ctaDescription: '加入Buoyancy Capital培训计划，获取专业K线分析工具和实战指导',
  ...
  en: {
    title: 'Candlestick Patterns Guide - Doji, Hammer, Engulfing Reversal & Continuation Patterns | Buoyancy Capital',
    ...
    ctaDescription: 'Join Buoyancy Capital training for professional candlestick analysis tools and practical guidance',
